...
typedef struct x264_param_t
{
    ...
    unsigned char     cqm_4iy[16];        /* used only if i_cqm_preset == X264_CQM_CUSTOM */
    unsigned char     cqm_4ic[16];
    unsigned char     cqm_4py[16];
    unsigned char     cqm_4pc[16];
    unsigned char     cqm_8iy[64];
    unsigned char     cqm_8py[64];
...
extern int x264_nal_encode_s( void *, int *, int b_annexeb, x264_nal_t *nal );
